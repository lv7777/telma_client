        ...
        for(var item of msg){
            ...
            switch(item.alert_type_id){
                case 1:
                    // 掲示板のコメント
                    //onclickの追加
                    listDom.find(".list__item__thumbnail").attr("list__item__thumbnail ons-icon fa-comment-o fa fa-2x");//TODO:
                    listDom.find(".list__item__title").html(item.title);
                    listDom.find(".list__item__subtitle").html(item.subtitle);
                    listDom.attr("onclick","");
                    break;
                ...
                case 3:
                    ...
                    //未承認ボタンの追加
                    //その後チャットへ
                    listDom.find(".list__item__thumbnail").attr("list__item__thumbnail ons-icon ion-android-alert ons-icon--ion fa-2x");//TODO:
                    listDom.find(".list__item__title").html(item.title);
                ...
                case 5:
                    // 評価通知
                    listDom.find(".list__item__thumbnail").attr("list__item__thumbnail ons-icon fa-star-o fa fa-2x");//TODO:
                    listDom.find(".list__item__title").html(item.title);
                    listDom.find(".list__item__subtitle").html("");
                ...
                case 6:
                    //掲示板新規投稿
                    listDom.find(".list__item__thumbnail").attr("list__item__thumbnail ons-icon fa-pencil fa fa-2x");
                    listDom.find(".list__item__title").html(item.title);
                    listDom.find(".list__item__subtitle").html(item.subtitle);
                    listDom.attr("onclick","");
                    break;
